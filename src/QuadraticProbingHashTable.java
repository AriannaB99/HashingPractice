...
public class QuadraticProbingHashTable<AnyType>
{
    ...
    private void findNth(int n ) {
        int not_null = 0;
        int i = 0;
        while (not_null < n && i < array.length) {
                if (array[i] != null) {
        ...
        if (i >= array.length) {
            System.out.println("We have reached the end of the results \nThere were " + not_null + " non-null entries in this table");
        }
    }
